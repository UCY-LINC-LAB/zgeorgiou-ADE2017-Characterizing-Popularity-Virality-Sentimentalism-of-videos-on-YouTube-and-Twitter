...
import com.zgeorg03.classification.records.YoutubeDay;
import com.zgeorg03.classification.records.YoutubeFeatures;
import com.zgeorg03.classification.records.ratioModels.age_ratioYouTube;
import com.zgeorg03.classification.records.ratioModels.ratioYouTube;
...
public class AllYoutubeFeatures {
    ...
    public AllYoutubeFeatures(int window, VideoData videoData,String yt){
        ...
        this.yt_uploaded = new Date(videoData.getYoutubeFeatures().getYt_uploaded());
