 ...
 */
public class ClassManager implements Runnable{
    private final Logger logger = LoggerFactory.getLogger(ClassManager.class);
    private final File root;

    private final Map<String,ClassificationFiles> experiments = new HashMap<>();

    public ClassManager(String workingDir) {
    ...
    private void checkDirs() {
        for(File dir :root.listFiles((dir, name) -> dir.isDirectory())){
            ...
            if(!experiments.containsKey(experimentId)) {
                ...
                experiments.put(experimentId,new ClassificationFiles(dir));
            }
        }
    }
